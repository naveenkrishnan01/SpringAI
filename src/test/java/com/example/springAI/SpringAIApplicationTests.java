...
import com.example.springAI.Contoller.ChatController;
...
class SpringAIApplicationTests {
	...
	@Test
	@DisplayName("Should return relevant response for basic pickleball question")
	@Timeout(value = 30)
	void evaluateChatControllerResponseRelevancy() {
		// Given
		String question = "which is the most popular sport in USA ?";
	...
	public void evaluateHrPolicyAnswerWithRagContext() throws IOException {
		...
		String retrievedContext = pickleBallTemplate.getContentAsString(Charset.defaultCharset());
